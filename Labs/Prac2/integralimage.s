...
.L847:
	...
	leaq	colormap__inferno(,%rsi,4), %rdx
	movss	colormap__inferno(,%rsi,4), %xmm5
	leaq	(%rax,%rax,2), %rsi
	mulss	%xmm0, %xmm5
	movss	4(%rdx), %xmm3
	movss	colormap__inferno(,%rsi,4), %xmm2
	leaq	colormap__inferno(,%rsi,4), %rax
	mulss	%xmm0, %xmm3
	mulss	%xmm1, %xmm2
	mulss	8(%rdx), %xmm0
	movq	%r15, %rdx
